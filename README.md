...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-21 11:52`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/4e7c97ec-be7e-44c7-8ee6-4f0a0a1ca65d.git
$ cd 4e7c97ec-be7e-44c7-8ee6-4f0a0a1ca65d
```
